...
import { getProductId, getSimilarProduct } from '@/lib/actions'
                    ...
                    <div className='product-info'>
                        ...
                        <div className='flex flex-col gap-4'>
                            <div className='flex gap-3'>
                                <div className='product-stars'>
                                    <Image 
                                     ...
                                     />
                                     <p className='text-sm text-primary-orange font font-semibold'>
                                        {product.stars || '25'}
                                     </p>
                                </div>
                            ...
                            <p className='text-sm text-black opacity-50'>
                                <span className='text-primary-green font-semibold'>90% </span> of buyers have recommended this.
                            </p>
                        </div>
                    </div>
            ...
            </div>
            {
               similarProducts && similarProducts?.length>0&& (
                    <div className='py-14 flex flex-col gap-2 w-full'>
                        ...
                        <div className='flex flex-warp gap-10 mt-7 w-full'>
